...
module.exports = new Command({
    ...
    async run(bot, msg) {
        try {
            const data = await fetch(`https://kawaii.red/api/gif/confused/token=${process.env.kawaii_api_key}/`, { method: 'GET' }).then(res => res.json());
            const embed = new discord.EmbedBuilder()
            .setDescription(`**${msg.author.username}** está muy confundido.`)
            .setColor('Random')
