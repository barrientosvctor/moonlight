...
module.exports = new Command({
    ...
    async run(bot, msg, args, prefix, getUser, getMember) {
        try {
            ...
            let data = await fetch(`https://kawaii.red/api/gif/protect/token=${process.env.kawaii_api_key}/`, { method: 'GET' }).then(res => res.json()),
