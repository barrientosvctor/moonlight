...
module.exports = new Command({
    ...
    enabled: true,
    botPerms: ['MANAGE_CHANNELS', 'ADMINISTRATOR', 'MODERATE_MEMBERS'],
    ...
    async run(bot, msg, args) {
        try {
            ...
            let resp = ['Sí.', 'No.', 'Lo dudo.', 'Lo dudo mucho.', 'Estoy indeciso.', 'No puedo responder esa pregunta en este momento.', 'Como yo lo veo, sí.', 'Me parece que sí.', 'No lo creo.', 'Sin duda', 'Tal vez no', '¿Y si no?', '¿Qué clase de pregunta es esa ${message.author.username}?', 'Tal vez sí.', 'Puede ser.', 'Tu pregunta me hizo dudar.', 'Sin lugar a dudas.', 'Sí, definitivamente.', 'Muy dudoso.', 'Respuesta confusa, vuelve a intentarlo.', 'Mis fuentes dicen que no.', 'No cuentes con ello.', 'No te puedo responder esa pregunta ahora.', 'Vuelve a preguntar más tarde.', 'Tal vez.'];
